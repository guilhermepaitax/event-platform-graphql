  ...
  return (
    <div className="flex-1">
      <div className="bg-black flex justify-center">
        <div className="max-w-[1100px] max-h-[60vh] w-full h-full aspect-video">
          <Player>
          ...
          <div className="flex flex-col gap-4">
            <a
              ...
              className="p-4 text-sm bg-green-500 flex items-center rounded 
                font-bold uppercase gap-2 justify-center hover:bg-green-700
                transition-colors"
            >
              <DiscordLogo size={24} />
            ...
            <a
              href=""
              className="p-4 text-sm flex border border-blue-500 text-blue-500
